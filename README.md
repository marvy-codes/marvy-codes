...
- Yieldoor (leveraged LP vault system)
- LayerEdge (tiered staking + Fenwick tree ranking)
- Pareto Dollar (synthetic stablecoin + vault queue)
- ETH0 Beta (wstETH-collateralized synthetic ETH)

I approach audits by:
- Mapping architecture first
- Identifying value entry & exit points
